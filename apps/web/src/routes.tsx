 ...
 *
 * No file-based routing and therefore no Vite plugin: three routes do not need
...
const routeTree = rootRoute.addChildren([dashboardRoute, artistsRoute, artistRoute])
...
export { artistRoute, artistsRoute, dashboardRoute }
