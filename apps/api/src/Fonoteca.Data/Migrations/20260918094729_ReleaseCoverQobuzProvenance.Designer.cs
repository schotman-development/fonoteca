...
namespace Fonoteca.Data.Migrations
{
    ...
    [Migration("20260918094729_ReleaseCoverQobuzProvenance")]
    partial class ReleaseCoverQobuzProvenance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fonoteca.Domain.Catalogue.MediaFile", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AcoustIdSubmittedUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Fonoteca.Domain.Catalogue.ReleaseCover", b =>
                {
                    b.Property<Guid>("ReleaseId")
                        .HasColumnType("uuid");

                    b.Property<long?>("ArchiveImageId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("QobuzAlbumId")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("Fonoteca.Domain.Catalogue.ReleaseCover", b =>
                {
                    b.HasOne("Fonoteca.Domain.Catalogue.Release", null)
                        .WithOne()
                        .HasForeignKey("Fonoteca.Domain.Catalogue.ReleaseCover", "ReleaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
