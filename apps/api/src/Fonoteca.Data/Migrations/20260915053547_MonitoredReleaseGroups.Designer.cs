...
namespace Fonoteca.Data.Migrations
{
    ...
    [Migration("20260915053547_MonitoredReleaseGroups")]
    partial class MonitoredReleaseGroups
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonoteca.Domain.Catalogue.Artist", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_Artists_Unbrowsed")
                        .HasFilter("\"Followed\" AND \"DiscographyLookupUtc\" IS NULL AND \"Mbid\" IS NOT NULL");
